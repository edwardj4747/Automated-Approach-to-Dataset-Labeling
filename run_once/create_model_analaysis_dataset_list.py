...
output_file_name = 'models_and_analyses_dict.json'
    ...
    for index, elements in enumerate(platforms):  # will sometimes be a list
        ...
        if platform_type == 'Models/Analyses':
            ...
            try:
                ...
                model_datasets_dict[short_name.lower()] = long_name.lower()
            except KeyError:
                model_datasets_dict[short_name.lower()] = ''
                pass
...
print("ofl", output_file_location)
with open(output_file_location, 'w') as f:
    json.dump(model_datasets_dict, f, indent=4)
