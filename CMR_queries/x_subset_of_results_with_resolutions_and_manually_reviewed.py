...
with open('results/3-22-15-Aura_omi_features.json', encoding='utf-8') as f:
    features = json.load(f)

with open('results/20-20-16_omi_papers_key_title_ground_truth.json', encoding='utf-8') as f:
...
with open('results/Aura_omi_resolutions_subset.json', 'w', encoding='utf-8') as f:
