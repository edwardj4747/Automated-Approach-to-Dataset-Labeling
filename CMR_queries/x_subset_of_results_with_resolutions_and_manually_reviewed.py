...
with open('cmr_results/aura-omi/3-22-15-Aura_omi_features.json', encoding='utf-8') as f:
    features = json.load(f)

with open('cmr_results/aura-omi/20-20-16_omi_papers_key_title_ground_truth.json', encoding='utf-8') as f:
...
with open('cmr_results/aura-omi/Aura_omi_resolutions_subset.json', 'w', encoding='utf-8') as f:
